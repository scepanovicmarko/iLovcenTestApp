...
export class PolicyUpdate extends React.Component<IPolicyUpdateProps, IPolicyUpdateState> {
  ...
  render() {
    const { policyEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="iLovcenTestApp.policy.home.createOrEditLabel">
              <Translate contentKey="iLovcenTestApp.policy.home.createOrEditLabel">Create or edit a Policy</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : policyEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="policy-name" type="text" name="name" />
                </AvGroup>
